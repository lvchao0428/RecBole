...
# Two-phase TF-IDF+LLM (Single-View) with Balanced Configuration (Toys Dataset)
...
echo "========================================="
echo "TF-IDF+LLM (Single-View) Balanced - Toys"
echo "========================================="
...
python scripts/two_phase_train.py \
  ...
  --config_files "sasrec_align_toys_qwen3_balanced.yaml" \
  --phase_a_grid \
  --align_grid "0.07" \
  ...
  --seed 2025 \
  --variant_features "sasrec,tfidf,llm,single_view,balanced,toys" \
  --watchdog_disable \
  --save

echo ""
echo "========================================="
echo "✅ TF-IDF+LLM Single-View Balanced (Toys) Done!"
echo "========================================="
