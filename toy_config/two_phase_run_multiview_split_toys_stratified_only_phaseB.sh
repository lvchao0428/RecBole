...
# Multi-View Split Training with Stratified Evaluation (Toys Dataset)
...
PHASE_A_CHECKPOINT="./saved/phase_runs_multiview_4views_toys_stratified/SASRecAlignMultiView-Dec-12-2025_12-07-55.pth"
...
python scripts/two_phase_train.py \
  ...
  --checkpoint_dir ./saved/phase_runs_multiview_4views_toys_stratified \
  --seed 2025 \
  --variant_features "sasrec,multiview,4views,per_view_align,qwen3,toys,stratified" \
  --watchdog_disable \
  --save
