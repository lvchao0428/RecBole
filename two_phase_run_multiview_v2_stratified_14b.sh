...
python scripts/two_phase_train.py \
  ...
  --config_dict "{'cold_start_align_boost': 3.0, 'cold_start_align_threshold': 10, 'inference_cold_text_boost': 0}" \
  --gpu_id $GPU_ID \
  --phase_a_grid \
  --align_grid "0.10" \
  --tau_grid "0.05" \
  ...
  --checkpoint_dir ./saved/two_phase_run_multiview_v2_stratified_14b \
  --seed 2025 \
