...
# Multi-View Split Training with Stratified Evaluation (ML-1M Dataset)
...
echo "========================================="
echo "Multi-View Split with Stratified Metrics (ML-1M)"
echo "========================================="
echo "Dataset: ml-1m"
...
python scripts/two_phase_train.py \
  ...
  --dataset ml-1m \
  --config_files "sasrec_align_multi_view_ml1m_stratified.yaml" \
  --phase_a_grid \
  --align_grid "0.05" \
  --tau_grid "0.05" \
  ...
  --checkpoint_dir ./saved/phase_runs_multiview_4views_ml1m_stratified \
  --seed 2025 \
  --variant_features "sasrec,multiview,4views,per_view_align,qwen3,ml1m,stratified" \
  --watchdog_disable \
  --save
