...
echo "SEED: $SEED"
echo "========================================="
echo "GRU4Rec Baseline (50ep, V3) with Stratified Metrics (beauty)"
echo "========================================="
...
python scripts/two_phase_train.py \
	...
	--only_phase_a \
	--checkpoint_dir "./saved/gru4rec_baseline_v3_beauty_stratified_seed${SEED}" \
	--seed "$SEED" \
	--variant_features "gru4rec,id_only,v3,beauty,stratified,seed_${SEED}" \
	--watchdog_disable \
	--save
