...
| Model | MRR@10 | NDCG@10 | HR@10 | MRR_new@10 | NDCG_new@10 | HR_new@10 |
|-------|:------:|:-------:|:-----:|:----------:|:-----------:|:---------:|
| ID-only (SASRec) | 0.0112 | 0.0151 | 0.0277 | — | — | — |
| + TF-IDF | 0.0162 | 0.0205 | 0.0348 | 0.0116 | 0.0143 | 0.0234 |
| + Single-View (LLM) | **0.0164** | **0.0209** | **0.0358** | **0.0121** | **0.0139** | 0.0198 |
| + Multi-View | 0.0158 | 0.0198 | 0.0330 | 0.0104 | 0.0119 | 0.0168 |
...
|-------|:------:|:-------:|:-----:|:----------:|:-----------:|:---------:|
| ID-only (SASRec) | 0.0112 | 0.0151 | 0.0277 | — | — | — |
| + TF-IDF | **0.0164** | 0.0202 | 0.0327 | 0.0119 | 0.0137 | 0.0193 |
| + Single-View (LLM) | 0.0162 | 0.0202 | **0.0335** | **0.0118** | **0.0143** | **0.0224** |
| + Multi-View | 0.0156 | 0.0196 | 0.0326 | 0.0106 | 0.0125 | 0.0183 |

### 频率分桶完整（no-Cross，test set）

| Model | MRR_freq | MRR_few | MRR_new | NDCG_freq | NDCG_few | NDCG_new | HR_freq | HR_few | HR_new |
|-------|:--------:|:-------:|:-------:|:---------:|:--------:|:--------:|:-------:|:------:|:------:|
| + TF-IDF | 0.0340 | 0.0177 | 0.0116 | 0.0439 | 0.0218 | 0.0143 | 0.0762 | 0.0349 | 0.0234 |
| + Single-View (LLM) | 0.0339 | **0.0186** | **0.0121** | **0.0449** | **0.0223** | **0.0139** | **0.0817** | 0.0341 | 0.0198 |
| + Multi-View | 0.0329 | **0.0186** | 0.0104 | 0.0428 | 0.0219 | 0.0119 | 0.0751 | 0.0328 | 0.0168 |

> 所有 @10 指标 | 数据集: Amazon Beauty | 协议: Global Time Split, min_train_interactions=5, leakage-free TF-IDF/LLM
