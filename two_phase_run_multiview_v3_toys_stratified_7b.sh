...
python scripts/two_phase_train.py \
	...
	--checkpoint_dir ./saved/two_phase_run_multiview_v3_toys_stratified_7b_${CHECKPOINT_TAG} \
	--seed 2025 \
	--variant_features "sasrec,multiview_v3,7b,toys,stratified,${CHECKPOINT_TAG}" \
	--watchdog_disable \
	--save
