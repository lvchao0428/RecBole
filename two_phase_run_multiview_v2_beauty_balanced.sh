...
# Multi-View V2 Balanced Training - Beauty (7B)
# ============================================================
# Balanced 配置设计原则:
...
echo "========================================="
echo "Multi-View V2 Balanced (7B) - Beauty"
echo "========================================="
...
python scripts/two_phase_train.py \
  ...
  --config_files "sasrec_align_multi_view_v2_beauty_balanced.yaml" \
  --phase_a_grid \
  --align_grid "0.07" \
  ...
  --seed 2025 \
  --variant_features "sasrec,multiview_v2,7b,balanced,cold_boost_2.0,beauty" \
  --watchdog_disable \
  --save

echo ""
echo "========================================="
echo "✅ Multi-View V2 Balanced 7B (Beauty) Done!"
echo "========================================="
