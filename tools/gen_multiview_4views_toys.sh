...
#
# Usage:
#   ./gen_multiview_4views_toys.sh [--no_whiten]
#
# Options:
#   --no_whiten   Disable whitening and centering transformation
...
echo "  - Total views: 4"
if [[ -n "$NO_WHITEN_FLAG" ]]; then
  echo "  - Whitening/Centering: DISABLED"
fi
echo ""
