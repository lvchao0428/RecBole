...
# 增强版Multi-View模型 - 使用 Qwen2.5-32B embeddings
#
...
echo "========================================="
echo "Multi-View V2 (32B) with Stratified Metrics (Toys)"
echo "========================================="
...
python scripts/two_phase_train.py \
  ...
  --seed 2025 \
  --variant_features "sasrec,multiview_v2,32b,4views,per_view_l2_norm,align_scale_2x,toys,stratified" \
  --watchdog_disable \
  --save
