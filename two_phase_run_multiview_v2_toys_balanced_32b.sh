...
# Multi-View V2 Balanced Training - Toys (32B)
# 用于验证 Scale Law
...
echo "========================================="
echo "Multi-View V2 Balanced (32B) - Toys"
echo "========================================="
...
python scripts/two_phase_train.py \
  ...
  --config_files "sasrec_align_multi_view_v2_toys_balanced_32b.yaml" \
  --phase_a_grid \
  --align_grid "0.07" \
  ...
  --seed 2025 \
  --variant_features "sasrec,multiview_v2,32b,balanced,cold_boost_2.0,toys" \
  --watchdog_disable \
  --save

echo ""
echo "========================================="
echo "✅ Multi-View V2 Balanced 32B (Toys) Done!"
echo "========================================="
