...
--config_files "${yaml_dir}/sasrec_align_multi_view_v3_toys_stratified_7b_no_align.yaml" \
...
--checkpoint_dir ./saved/two_phase_run_multiview_v3_toys_stratified_7b \
--seed 2025 \
--variant_features "sasrec,multiview_v3,7b,toys,stratified" \
--watchdog_disable \
--save
