#!/usr/bin/env bash
#
# exp_sensitivity_tau_010.sh - Sensitivity Analysis: temperature = 0.10
#
# 目的: 验证平滑对比学习对冷启动的影响
# 基准: λ=0.10, τ=0.05, cold=2.0, infer=1.0
# 变化: τ=0.05 → 0.10 (更平滑)
# 预期: HR_new↓ (冷启动物品受损), MRR/NDCG 稳定或略降
#
...
GPU_ID=${GPU_ID:-0}
echo "========================================="
echo "Sensitivity Analysis: temperature = 0.10"
echo "Using GPU: $GPU_ID"
echo "========================================="
echo "  - alignment_weight: 0.10 (baseline)"
echo "  - temperature: 0.05 → 0.10 (平滑对比学习)"
...
python scripts/two_phase_train.py \
  ...
  --checkpoint_dir ./saved/sensitivity_tau_010 \
  --seed 2025 \
  --variant_features "sasrec,multiview_v2,7b,toys,tau_010" \
  --watchdog_disable \
  --save

echo "✅ Done! Check: saved/sensitivity_tau_010/"
