#!/usr/bin/env bash
#
# exp_seed42_toys_tfidf.sh - Seed Experiment: TF-IDF on Toys with seed=42
#
# 目的: 验证主表结果的统计显著性
...
GPU_ID=${GPU_ID:-0}
echo "========================================="
echo "Seed Experiment: TF-IDF on Toys (seed=42)"
...
python scripts/two_phase_train.py \
  ...
  --checkpoint_dir ./saved/seed42_toys_tfidf \
  --seed 42 \
  --variant_features "sasrec,tfidf,toys,seed42" \
  --watchdog_disable \
  --save

echo "✅ Done! Check: saved/seed42_toys_tfidf/"
