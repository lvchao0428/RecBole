#!/usr/bin/env bash
#
# exp_fair_multiview_no_boost_toys.sh - Multi-view 无 boost (Toys)
#
...
GPU_ID=${GPU_ID:-0}
echo "========================================="
echo "Fair Comparison: Multi-view NO Boost (Toys)"
...
python scripts/two_phase_train.py \
  ...
  --checkpoint_dir ./saved/exp_fair_multiview_no_boost_toys \
  --seed 2025 \
  --variant_features "sasrec,multiview_v2,7b,toys,fair_no_boost" \
  --watchdog_disable \
  --save

echo "✅ Done! Check: saved/exp_fair_multiview_no_boost_toys/"
