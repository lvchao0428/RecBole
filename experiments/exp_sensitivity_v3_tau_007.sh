#!/usr/bin/env bash
#
# exp_sensitivity_v3_tau_007.sh - Sensitivity Analysis: temperature = 0.07
#
# 基准: align_weight=0.10, τ=0.05, cold_text_boost=3.0, infer_boost=0.6
# 变化: τ=0.05 → 0.07 (较平滑对比学习)
#
...
GPU_ID=${GPU_ID:-0}
echo "========================================="
echo "Sensitivity Analysis: temperature = 0.07"
echo "Using GPU: $GPU_ID"
echo "========================================="
echo "  - align_weight: 0.10 (baseline)"
echo "  - temperature: 0.05 → 0.07 (较平滑对比学习)"
...
python scripts/two_phase_train.py \
  ...
  --checkpoint_dir ./saved/sensitivity_v3_tau_007 \
  --seed 42 \
  --variant_features "sasrec,multiview_v3,7b,toys,tau_007" \
  --watchdog_disable \
  --save

echo "✅ Done! Check: saved/sensitivity_v3_tau_007/"
