#!/usr/bin/env bash
#
# exp_sensitivity_v3_tau_003.sh - Sensitivity Analysis: temperature = 0.03
#
# 基准: align_weight=0.10, τ=0.05, cold_text_boost=3.0, infer_boost=0.6
# 变化: τ=0.05 → 0.03 (更锐利对比学习)
#
...
echo "  - temperature: 0.05 → 0.03 (更锐利对比学习)"
...
echo "✅ Done! Check: saved/sensitivity_v3_tau_003/"
