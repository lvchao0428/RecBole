#!/usr/bin/env bash
#
# exp_tfidf_toys_with_boost.sh - TF-IDF with cold-start boost for Toys
#
...
GPU_ID=${GPU_ID:-0}
echo "========================================="
echo "TF-IDF with Cold-start Boost (Toys)"
...
python scripts/two_phase_train.py \
  ...
  --checkpoint_dir ./saved/tfidf_toys_with_boost \
  --seed 2025 \
  --variant_features "sasrec,tfidf,toys,agg_boost" \
  --watchdog_disable \
  --save

echo "✅ Done! Check: saved/tfidf_toys_with_boost/"
