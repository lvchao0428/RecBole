#!/bin/bash
# exp_inference_boost_toys_32b.sh
# 目的：验证 Toys 32B + CHANGE-9 的 Scale Law
# 
# 当前发现：
...
CONFIG_FILE="sasrec_align_multi_view_v2_toys_inference_boost_32b.yaml"

echo "=========================================="
echo " exp_inference_boost_toys_32b"
echo " Toys 32B + CHANGE-9"
echo " GPU: $GPU_ID"
echo "=========================================="
echo ""
echo "Configuration:"
...
python scripts/two_phase_train.py \
    ...
    --variant_features "inference_boost_toys_32b"
