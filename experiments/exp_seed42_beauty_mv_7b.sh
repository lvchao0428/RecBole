#!/usr/bin/env bash
#
# exp_seed42_beauty_mv_7b.sh - Seed Experiment: Multi-view 7B on Beauty with seed=42
#
# 目的: 验证主表结果的统计显著性
...
GPU_ID=${GPU_ID:-0}
echo "========================================="
echo "Seed Experiment: Multi-view 7B on Beauty (seed=42)"
...
python scripts/two_phase_train.py \
  ...
  --checkpoint_dir ./saved/seed42_beauty_mv_7b \
  --seed 42 \
  --variant_features "sasrec,multiview_v2,7b,beauty,agg,seed42" \
  --watchdog_disable \
  --save

echo "✅ Done! Check: saved/seed42_beauty_mv_7b/"
