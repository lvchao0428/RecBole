#!/usr/bin/env bash
#
# exp_sensitivity_v3_tau_010.sh - Sensitivity Analysis: temperature = 0.10
#
# 基准: align_weight=0.10, τ=0.05, cold_text_boost=3.0, infer_boost=0.6
# 变化: τ=0.05 → 0.10 (平滑对比学习)
#
...
python scripts/two_phase_train.py \
  ...
  --checkpoint_dir ./saved/sensitivity_v3_tau_010 \
  --seed 42 \
  --variant_features "sasrec,multiview_v3,7b,toys,tau_010" \
  --watchdog_disable \
  --save

echo "✅ Done! Check: saved/sensitivity_v3_tau_010/"
