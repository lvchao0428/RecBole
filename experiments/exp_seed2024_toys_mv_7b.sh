#!/usr/bin/env bash
#
# exp_seed2024_toys_mv_7b.sh - Seed Experiment: Multi-view 7B on Toys with seed=2024
#
# 目的: 验证主表结果的统计显著性
...
GPU_ID=${GPU_ID:-0}
echo "========================================="
echo "Seed Experiment: Multi-view 7B on Toys (seed=2024)"
...
python scripts/two_phase_train.py \
  ...
  --checkpoint_dir ./saved/seed2024_toys_mv_7b \
  --seed 2024 \
  --variant_features "sasrec,multiview_v2,7b,toys,agg,seed2024" \
  --watchdog_disable \
  --save

echo "✅ Done! Check: saved/seed2024_toys_mv_7b/"
