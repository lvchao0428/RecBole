#!/usr/bin/env bash
#
# exp_fair_tfidf_llm_cold2_beauty.sh - TF-IDF+LLM + cold_boost=2.0 (Beauty)
#
...
GPU_ID=${GPU_ID:-0}
echo "========================================="
echo "Fair Comparison: TF-IDF+LLM + cold_boost=2.0 (Beauty)"
...
python scripts/two_phase_train.py \
  ...
  --checkpoint_dir ./saved/exp_fair_tfidf_llm_cold2_beauty \
  --seed 2025 \
  --variant_features "sasrec,tfidf_llm,beauty,fair_cold2" \
  --watchdog_disable \
  --save

echo "✅ Done! Check: saved/exp_fair_tfidf_llm_cold2_beauty/"
