#!/usr/bin/env bash
#
# exp_tfidf_beauty_aggressive.sh - TF-IDF on Beauty with Aggressive config
#
...
GPU_ID=${GPU_ID:-0}
echo "========================================="
echo "Main Table: TF-IDF on Beauty (Aggressive)"
...
python scripts/two_phase_train.py \
  ...
  --checkpoint_dir ./saved/main_tfidf_beauty_aggressive \
  --seed 2025 \
  --variant_features "sasrec,tfidf,beauty,aggressive,main" \
  --watchdog_disable \
  --save

echo "✅ Done! Check: saved/main_tfidf_beauty_aggressive/"
