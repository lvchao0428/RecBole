...
# Two-phase TF-IDF+LLM with Stratified Evaluation + Cold-Start Alignment Boost for S3Rec
...
echo "========================================="
echo "S3Rec TF-IDF+LLM with Stratified Metrics + Cold-Start Boost"
echo "========================================="
...
python scripts/two_phase_train.py \
  ...
  --config_files "s3rec_align_qwen3_stratified.yaml" \
  --phase_a_grid \
  --align_grid "0.03" \
  --tau_grid "0.1" \
  ...
  --seed 2025 \
  --variant_features "s3rec,tfidf,llm,beauty,stratified,cold_start_align_boost" \
  --watchdog_disable \
  --save
