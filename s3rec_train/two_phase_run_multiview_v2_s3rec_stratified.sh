...
# Multi-View V2 Training with Stratified Evaluation for S3Rec (finetune stage)
# 增强版Multi-View模型
#
...
echo "========================================="
echo "S3Rec Multi-View V2 with Stratified Metrics"
echo "========================================="
...
python scripts/two_phase_train.py \
  --model S3RecAlignMultiViewV2 \
  --dataset Amazon_Beauty \
  --config_files "s3rec_align_multi_view_v2_stratified.yaml" \
  --phase_a_grid \
  --align_grid "0.03" \
  --tau_grid "0.1" \
  ...
  --checkpoint_dir ./saved/phase_runs_multiview_v2_s3rec_stratified \
  --seed 2025 \
  --variant_features "s3rec,multiview_v2,4views,per_view_l2_norm,align_scale_2x,stratified" \
  --watchdog_disable \
  --save
