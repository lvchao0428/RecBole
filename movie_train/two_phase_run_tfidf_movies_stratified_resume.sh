...
# Resume Phase-B training from checkpoint (TF-IDF baseline, Movies)
...
CHECKPOINT_PATH="./saved/phase_runs_movies_stratified/SASRec_Align-Dec-13-2025_13-27-11.pth"
...
echo "========================================="
echo "Resume Phase-B: TF-IDF Baseline (Movies)"
echo "========================================="
...
python scripts/two_phase_train.py \
  ...
  --seed 2025 \
  --variant_features "sasrec,tfidf,movies,stratified,resumed" \
  --watchdog_disable \
  --save
