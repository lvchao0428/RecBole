...
# Two-phase TF-IDF baseline with Stratified Evaluation for BERT4Rec
...
echo "========================================="
echo "BERT4Rec TF-IDF Baseline with Stratified Metrics"
echo "========================================="
...
python scripts/two_phase_train.py \
  ...
  --config_files "${yaml_dir}/bert4rec_align_base_stratified.yaml" \
  --phase_a_grid \
  --align_grid "0.03" \
  --tau_grid "0.1" \
  ...
  --seed 2025 \
  --variant_features "bert4rec,tfidf,beauty,stratified" \
  --watchdog_disable \
  --save
...
echo "========================================="
echo "Check results:"
echo "  - Checkpoints: saved/phase_runs_bert4rec_stratified/"
echo "  - Logs: log/"
echo ""
