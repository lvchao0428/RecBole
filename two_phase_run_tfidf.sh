...
# Two-phase strong baseline: SASRec_Align + TF-IDF (base only)
...
python scripts/two_phase_train.py \
  ...
  --config_files "sasrec_align_base.yaml overrides/stability_enhance_with_id_ln.yaml overrides/text_base_abs.yaml" \
  --phase_a_grid \
