...
Through controlled ablations of contrastive and cold-start hyperparameters, we expose an HR--ranking trade-off governed by the cross network and show that multi-view prompting, under equal embedding bandwidth, improves ranking quality on cold-start items compared with all text baselines.
