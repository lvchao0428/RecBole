...
consistently improves over the ID-only baseline. The key findings are:
%% TODO: fill in specific numbers once experiments converge.

\paragraph{Text features provide large gains over ID-only.}
\tfidf alone provides substantial gains on both datasets.
Multi-view \model further improves over single-view baselines,
maintaining the hierarchy
\model $>$ TF-IDF+LLM $>$ TF-IDF $>$ ID-only on all overall metrics.

\paragraph{Cold-start (new/few) improvements.}
Multi-view provides notable gains on \textbf{new} and \textbf{few}
strata compared to baselines, confirming that diverse prompt
perspectives help cold-start items. For the \textbf{new} stratum,
we observe an HR--ranking trade-off where explicit cross sharpens
score distributions for ranking quality at the cost of recall coverage.


\begin{table*}[t]
\caption{Main results under full ranking on Amazon Beauty and Toys\&Games.
Best results per dataset in \textbf{bold}. All values are percentages (\%)
reported as mean $\pm$ std over three seeds (2025/2024/42).}
\label{tab:main}
\centering
\small
%% TODO: replace placeholder values (--) with final numbers once experiments converge.
\begin{tabular}{lcccccccccc}
\toprule
\multirow{2}{*}{\textbf{Model}} &
\multicolumn{3}{c}{\textbf{Overall}} &
\multicolumn{3}{c}{\textbf{new} $[1,3)$} &
\multicolumn{2}{c}{\textbf{few} $[3,10)$} &
\multicolumn{2}{c}{\textbf{freq.} $[10,\infty)$} \\
\cmidrule(lr){2-4}\cmidrule(lr){5-7}\cmidrule(lr){8-9}\cmidrule(lr){10-11}
& HR@10 & NDCG@10 & MRR@10 & HR@10 & NDCG@10 & MRR@10 & HR@10 & MRR@10 & HR@10 & MRR@10 \\
\midrule
\multicolumn{11}{l}{\textbf{Amazon Beauty}} \\
\base (ID-only) & 4.69 $\pm$ 0.00 & 2.69 $\pm$ 0.00 & 2.07 $\pm$ 0.00 & 1.71 $\pm$ 0.00 & 1.01 $\pm$ 0.00 & 0.79 $\pm$ 0.00 & 3.33 $\pm$ 0.00 & 1.56 $\pm$ 0.00 & 7.86 $\pm$ 0.00 & 3.42 $\pm$ 0.00 \\
\base + \tfidf & 5.56 $\pm$ 0.03 & 3.69 $\pm$ 0.02 & 3.11 $\pm$ 0.02 & 1.62 $\pm$ 0.02 & 1.21 $\pm$ 0.03 & 1.07 $\pm$ 0.04 & 3.33 $\pm$ 0.07 & 2.05 $\pm$ 0.04 & 9.74 $\pm$ 0.06 & 5.31 $\pm$ 0.00 \\
\base + \tfidf + \llm (7B) & 5.63 $\pm$ 0.03 & 3.73 $\pm$ 0.02 & 3.15 $\pm$ 0.02 & 1.64 $\pm$ 0.03 & 1.24 $\pm$ 0.02 & \textbf{1.11 $\pm$ 0.02} & 3.36 $\pm$ 0.06 & 2.08 $\pm$ 0.02 & 9.86 $\pm$ 0.03 & 5.35 $\pm$ 0.03 \\
\model (7B) & \textbf{5.78 $\pm$ 0.04} & \textbf{3.79 $\pm$ 0.03} & \textbf{3.19 $\pm$ 0.02} & \textbf{1.76 $\pm$ 0.06} & \textbf{1.26 $\pm$ 0.01} & 1.10 $\pm$ 0.02 & \textbf{3.55 $\pm$ 0.02} & \textbf{2.19 $\pm$ 0.01} & \textbf{10.05 $\pm$ 0.08} & \textbf{5.39 $\pm$ 0.03} \\
\midrule
\multicolumn{11}{l}{\textbf{Amazon Toys\&Games}} \\
\base (ID-only) & 5.97 $\pm$ 0.00 & 3.32 $\pm$ 0.00 & 2.49 $\pm$ 0.00 & 1.91 $\pm$ 0.00 & 1.10 $\pm$ 0.00 & 0.84 $\pm$ 0.00 & 4.61 $\pm$ 0.00 & 1.87 $\pm$ 0.00 & 10.61 $\pm$ 0.00 & 4.45 $\pm$ 0.00 \\
\base + \tfidf & 6.29 $\pm$ 0.04 & 4.27 $\pm$ 0.01 & 3.64 $\pm$ 0.00 & 1.82 $\pm$ 0.02 & 1.37 $\pm$ 0.02 & 1.23 $\pm$ 0.02 & 4.63 $\pm$ 0.05 & 2.76 $\pm$ 0.02 & 11.39 $\pm$ 0.07 & 6.48 $\pm$ 0.02 \\
\base + \tfidf + \llm (7B) & 6.39 $\pm$ 0.02 & 4.33 $\pm$ 0.01 & 3.68 $\pm$ 0.00 & 1.92 $\pm$ 0.02 & 1.43 $\pm$ 0.01 & 1.27 $\pm$ 0.01 & 4.72 $\pm$ 0.03 & 2.83 $\pm$ 0.02 & 11.54 $\pm$ 0.05 & \textbf{6.53 $\pm$ 0.01} \\
\model (7B) & \textbf{6.59 $\pm$ 0.02} & \textbf{4.38 $\pm$ 0.02} & \textbf{3.70 $\pm$ 0.02} & \textbf{2.05 $\pm$ 0.03} & \textbf{1.47 $\pm$ 0.02} & \textbf{1.29 $\pm$ 0.02} & \textbf{4.98 $\pm$ 0.10} & \textbf{2.89 $\pm$ 0.02} & \textbf{11.81 $\pm$ 0.03} & 6.52 $\pm$ 0.06 \\
\bottomrule
\end{tabular}
\end{table*}
...
%% TODO: update ablation numbers once experiments converge.
...
Multi-view w/ Whiten & -- & -- & -- & -- \\
Multi-view w/o Whiten & -- & -- & -- & -- \\
Single-view w/ Whiten & -- & -- & -- & -- \\
Single-view w/o Whiten & -- & -- & -- & -- \\
\bottomrule
\end{tabular}
\end{table}
...
while \textbf{enabling cross} causes HR$\downarrow$ MRR$\uparrow$
...
%% TODO: fill in exact relative changes once final numbers are available.
...
\begin{itemize}[leftmargin=*,itemsep=2pt]
  \item \textbf{Candidate generation / recall-oriented systems}:
    Disable cross to achieve higher HR at the cost of lower MRR.
