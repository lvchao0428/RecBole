...
%
Under full-ranking evaluation on Amazon Beauty and Toys\&Games, \model achieves HR@10 of \textbf{5.79}\% and \textbf{6.61}\% respectively, with notable cold-start gains (HR\_new@10 up to \textbf{2.04}\%, HR\_few@10 up to \textbf{4.88}\%).
%
