...
%% TODO(advisor): Ensure all figures are grayscale-friendly —
%%   use distinct line styles (solid/dashed/dotted) and markers,
%%   not just color, to differentiate series. Enlarge font sizes
%%   and legends so they remain legible in two-column print.
\begin{figure}[t]
\centering
