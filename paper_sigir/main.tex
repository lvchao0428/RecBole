...
\cmidrule(lr){2-4}\cmidrule(lr){5-7}
\textbf{Model} & HR & NDCG & MRR & HR & NDCG & MRR \\
\midrule
...
\begin{table}[t]
\caption{Aggressive configuration results on Toys\&Games (@10). All values are percentages (\%).}
\label{tab:aggressive}
\centering
\small
\begin{tabular}{lcccc}
\toprule
\textbf{Model} & \textbf{HR} & \textbf{NDCG} & \textbf{HR\_new} & \textbf{HR\_few} \\
\midrule
