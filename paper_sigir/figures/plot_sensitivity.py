...
# Grayscale-friendly colors with distinct markers and line styles
colors = {
    'HR@10': '#1a1a1a',      # Near-black
    'NDCG@10': '#666666',    # Medium gray
    'MRR@10': '#999999',     # Light gray
    'HR_new@10': '#444444',  # Dark gray
}
...
def create_pareto_plot(data_file=DEFAULT_DATA_FILE, metric_pair='ndcg', show=False):
    ...
    param_colors = {
        'lambda':     '#1a1a1a',  # near-black
        'tau':        '#555555',  # dark gray
        'cold_boost': '#888888',  # medium gray
        'infer_boost':'#bbbbbb',  # light gray
    }
    param_markers = {
        'lambda':     'o',
        'tau':        's',
    ...
    ax.step(
        pf_hr + [pf_hr[-1] + 0.05],
        [pf_oth[0]] + pf_oth,
        where='post', color='#333333', linewidth=2.5, linestyle='--',
    ...
    legend_handles['_pareto'] = mlines.Line2D(
        [], [], color='#333333', linestyle='--', linewidth=2.5,
