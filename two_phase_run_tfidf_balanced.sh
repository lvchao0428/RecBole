...
# Two-phase TF-IDF baseline with Balanced Configuration
...
python scripts/two_phase_train.py \
  ...
  --config_files "sasrec_align_base_balanced.yaml" \
  --phase_a_grid \
  --align_grid "0.07" \
  ...
  --checkpoint_dir ./saved/phase_runs_balanced \
  --seed 2025 \
  --variant_features "sasrec,tfidf,balanced,beauty" \
  --watchdog_disable \
  --save

echo ""
echo "========================================="
echo "✅ TF-IDF Balanced (Beauty) Done!"
echo "========================================="
